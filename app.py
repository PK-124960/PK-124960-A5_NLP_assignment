...
st.markdown("<p style='text-align:center; font-size:1.3rem; color:white;'>Enter a text prompt and see how the AI rates different responses!</p>", unsafe_allow_html=True)
...
if st.button("🔍 Evaluate Response"):
    if user_input.strip() == "":
        ...
        st.markdown("<h2 style='text-align:center; color:white;'>📝 AI Evaluation:</h2>", unsafe_allow_html=True)
        ...
        if probability > 0.8:
            st.markdown("<p style='text-align:center; font-size:1.2rem; color:#0f5132; background:#d4edda; padding:10px; border-radius:10px;'>✅ AI finds this response highly relevant!</p>", unsafe_allow_html=True)
        elif probability > 0.5:
            st.markdown("<p style='text-align:center; font-size:1.2rem; color:#856404; background:#fff3cd; padding:10px; border-radius:10px;'>⚖️ AI finds this response neutral.</p>", unsafe_allow_html=True)
        else:
            st.markdown("<p style='text-align:center; font-size:1.2rem; color:#721c24; background:#f8d7da; padding:10px; border-radius:10px;'>❌ AI finds this response less relevant.</p>", unsafe_allow_html=True)
